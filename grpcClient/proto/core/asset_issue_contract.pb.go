...
func (m *AssetIssueContract) GetVoteScorev2() int32 {
	if m != nil {
		return m.VoteScorev2
	}
	return 0
}
...
func init() {
	proto.RegisterFile("corev2/contract/asset_issue_contract.proto", fileDescriptor_7a53d522aa45c6a0)
}
