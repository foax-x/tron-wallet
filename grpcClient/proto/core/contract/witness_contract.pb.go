...
// 	protoc        v3.11.4
// source: corev2/contract/witness_contract.proto
...
func (x *WitnessCreateContract) Reset() {
	*x = WitnessCreateContract{}
	if protoimpl.UnsafeEnabled {
		mi := &file_corev2_contract_witness_contract_proto_msgTypes[0]
...
func (*WitnessCreateContract) Descriptor() ([]byte, []int) {
	return file_corev2_contract_witness_contract_proto_rawDescGZIP(), []int{0}
}
...
func (x *WitnessUpdateContract) Reset() {
	*x = WitnessUpdateContract{}
	if protoimpl.UnsafeEnabled {
		mi := &file_corev2_contract_witness_contract_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WitnessUpdateContract) Descriptor() ([]byte, []int) {
	return file_corev2_contract_witness_contract_proto_rawDescGZIP(), []int{1}
}
...
func (x *VoteWitnessContract) Reset() {
	*x = VoteWitnessContract{}
	if protoimpl.UnsafeEnabled {
		mi := &file_corev2_contract_witness_contract_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*VoteWitnessContract) Descriptor() ([]byte, []int) {
	return file_corev2_contract_witness_contract_proto_rawDescGZIP(), []int{2}
}
...
func (x *VoteWitnessContract_Vote) Reset() {
	*x = VoteWitnessContract_Vote{}
	if protoimpl.UnsafeEnabled {
		mi := &file_corev2_contract_witness_contract_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*VoteWitnessContract_Vote) Descriptor() ([]byte, []int) {
	return file_corev2_contract_witness_contract_proto_rawDescGZIP(), []int{2, 0}
}
...
var File_corev2_contract_witness_contract_proto protoreflect.FileDescriptor

var file_corev2_contract_witness_contract_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x4b, 0x0a, 0x18, 0x6f, 0x72, 0x67, 0x2e,
	0x74, 0x72, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x63, 0x6f, 0x6e, 0x74,
	0x72, 0x61, 0x63, 0x74, 0x5a, 0x2f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
...
var (
	file_corev2_contract_witness_contract_proto_rawDescOnce sync.Once
	file_corev2_contract_witness_contract_proto_rawDescData = file_corev2_contract_witness_contract_proto_rawDesc
)

func file_corev2_contract_witness_contract_proto_rawDescGZIP() []byte {
	file_corev2_contract_witness_contract_proto_rawDescOnce.Do(func() {
		file_corev2_contract_witness_contract_proto_rawDescData = protoimpl.X.CompressGZIP(file_corev2_contract_witness_contract_proto_rawDescData)
	})
	return file_corev2_contract_witness_contract_proto_rawDescData
}

var file_corev2_contract_witness_contract_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_corev2_contract_witness_contract_proto_goTypes = []interface{}{
...
var file_corev2_contract_witness_contract_proto_depIdxs = []int32{
...
func init() { file_corev2_contract_witness_contract_proto_init() }
func file_corev2_contract_witness_contract_proto_init() {
	if File_corev2_contract_witness_contract_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_corev2_contract_witness_contract_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_corev2_contract_witness_contract_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_corev2_contract_witness_contract_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_corev2_contract_witness_contract_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_corev2_contract_witness_contract_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_corev2_contract_witness_contract_proto_goTypes,
		DependencyIndexes: file_corev2_contract_witness_contract_proto_depIdxs,
		MessageInfos:      file_corev2_contract_witness_contract_proto_msgTypes,
	}.Build()
	File_corev2_contract_witness_contract_proto = out.File
	file_corev2_contract_witness_contract_proto_rawDesc = nil
	file_corev2_contract_witness_contract_proto_goTypes = nil
	file_corev2_contract_witness_contract_proto_depIdxs = nil
}
